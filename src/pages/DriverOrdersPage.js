            ...
            <div className="w-full flex space-x-3 justify-between">
              ...
              <div>
                {orderStatus === "Preparing" && (
                  <OrangeLabel>{orderStatus}</OrangeLabel>
                )}
                {orderStatus === "Delivered" && (
                  <GreenLabel>{orderStatus}</GreenLabel>
                )}
                {orderStatus === "Canceled" && (
                  <RedLabel>{orderStatus}</RedLabel>
                )}
                {orderStatus === "Ready" && (
                  <YellowLabel>{orderStatus}</YellowLabel>
                )}
                {orderStatus === "Out for Delivery" && (
                  <BlueLabel>{orderStatus}</BlueLabel>
                )}
              </div>
            </div>
            <div className=""></div>
