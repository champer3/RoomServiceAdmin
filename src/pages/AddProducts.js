      ...
      <div className="flex">
        <div className="w-[70%] p-3">
          <div className="mt-8 rounded-xl bg-white p-4">
            <p className="mb-3 font-bold text-[18px] leading-[28px] tracking-[0.01em] text-[#333333]">
              General Information
            </p>
            <Input
              label="Product Name"
          ...
          <div className="mt-8 rounded-xl bg-white p-4 ">
            <div className=" flex items-center space-x-3">
                ...
                {product.instructions ? (
                  ...
                  >
                    ...
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M15.9471 4.77386C16.3021 5.06675 16.3525 5.59197 16.0596 5.94699L8.91046 14.6126C8.76057 14.7943 8.49 14.8157 8.31338 14.6598L4.44874 11.2499C4.10364 10.9454 4.07072 10.4188 4.37523 10.0737C4.67973 9.72855 5.20634 9.69563 5.55144 10.0001L8.44716 12.5552L14.7739 4.88635C15.0668 4.53134 15.5921 4.48097 15.9471 4.77386Z"
                      fill="white"
                    />
                  </svg>
                ) : (
              ...
              <p className="ml-1 text-[14px] font-semibold text-[#283618] ">
                Include Instructions
              </p>
              <button
                onClick={() =>
                  setProduct({ ...product, extra: !product.extra })
                }
              >
                {product.extra ? (
                  <svg
        ...
        <div className="w-[30%] p-3">
          <div className="mt-8 rounded-xl bg-white p-4">
            ...
            <div className=" rounded-xl bg-white p-4">
              <p className="mb-3  text-[15px] leading-[28px] tracking-[0.01em] text-[#333333]">
                Product Variations
              </p>
              <div className="flex items-center">
                <input
          ...
          <div className="mt-8 rounded-xl bg-white p-4">
            ...
            <Select
              ...
              choices={["Available", "Out of Stock"]}
              handleOptionSelected={handleSelectStatus}
            />
          </div>
        </div>
      </div>
