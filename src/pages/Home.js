...
export default function HomePage() {
  ...
  const lastPage =
    TABLE_DATA.length % itemsPerPage === 0
      ? TABLE_DATA.length / itemsPerPage
      : Math.floor(TABLE_DATA.length / itemsPerPage) + 1;
  ...
  function handlePageClick(pageNum) {
    ...
    setShownItems(
      TABLE_DATA.slice((pageNum - 1) * itemsPerPage, pageNum * itemsPerPage)
    );
  }
      ...
      <div className="ml-4">
        ...
        <div className="flex items-center">
          <div>
            ...
            <p className="text-customAsh mb-4 font-extrabold text-[18px] leading-[28px] tracking-[0.01em]">
              See statistics, manage products and orders.
            </p>
          </div>
        ...
        <div className="relative">
          <div className="fixed right-[30%] bottom-[20%] font-[800] text-4xl flex">
            <p>Coming Soon...</p>
            <svg
              width="40px"
              height="40px"
          ...
          <div className="opacity-25">
            <div className="my-4 rounded-lg bg-white p-4">
              <p className="font-semibold text-[20px] leading-[30px] tracking=[0.01em] text-[#333333]">
                Statistic
              </p>
              <p className="font-extrabold text-[14px] leading-[20px] tracking-[0.005em] text-[#777980]">
                Revenue and Sales
              </p>
              <div className="">
                <svg
            ...
            <div className="my-8 space-x-8 flex">
              <ContentContainer
                label={"Top Products"}
                subheading={"Top products in this month"}
              >
                {PRODUCT_DATA.map((product) => {
                  return (
                    <div key={product.productName} className="mt-4 mb-6">
                      <ProductListing
              ...
              <ContentContainer
                ...
                subheading={"Top categories in this month"}
              >
                {/* <CategoryListing
            percent={10}
            image={productImg}
            category={"Snacks"}
            imageBackground={"#F4ECFB"}
            amount={1509}
          /> */}
            ...
            <div className="my-8 space-x-8 flex">
              <div className="bg-white rounded-lg">
                <div className="rounded-lg bg-white p-4 items-center flex">
                  ...
                  <div className="ml-auto flex space-x-4">
                    <SelectDatesButton />
                    <FilterButton />
                    <StyledDashboardButton handleClick={() => handleSeeAll()}>
                      {seeAll ? "Unsee All" : "See All"}
                ...
                {!seeAll && (
                  <>
                        ...
                        <tr className="border-t border-b bg-[#F9F9FC]">
                          <th className="pl-6">
                            <TableHead
                              heading={"Product"}
                              canOrder={true}
                              ascend={() => handleAscendingSort("product")}
                              descend={() => handleDescendingSort("product")}
                              active={activeColumn === "product"}
                            />
                          </th>
                          <th className="pl-8">
                        ...
                        {shownItems.map((order) => {
                          return (
                            <tr className="border-b">
                              ...
                              <td className="">
                                <TableTotalListing amount={order.total} />
                              </td>
                              <td className="">
                                <TableStatusListing status={order.status} />
                              </td>
                              <td className="">
                                <TableActionListing />
                              </td>
                    ...
                    <div className="rounded-b-xl p-4 items-center flex">
                      ...
                      <div className="ml-auto flex space-x-2">
                        ...
                        >
                          <StyledDashboardButton isDisabled={currentPage === 1}>
                            <svg
                              width="20"
                              height="20"
                              viewBox="0 0 20 20"
                        ...
                        <StyledDashboardButton
                          handleClick={() =>
                            handlePageClick(
                              Math.min(shownItems.length, currentPage + 1)
                            )
                          }
              ...
              <div className="">
                <div className="rounded-lg bg-white">
                  <ContentContainer
                    ...
                    subheading={"Based on States"}
                  >
                    <img src={mapImg} alt="" />
                  </ContentContainer>
                  <div class="h-[350px] overflow-auto scrollbar-thin scrollbar-thumb-rounded-lg scrollbar-thumb-[#BC6C25] scrollbar-track-gray-100">
                    {STATES_DATA.map((state) => {
                      return (
                        <div
                          key={state.name}
                          className=" ml-auto mr-auto w-[312px] bg-[#FFFFFF] mt-3 p-2 flex items-center"
                        >
                          <StateListing
                            img={state.image}
                            state={state.name}
                            customerTotal={state.customers}
                          />
                          <div className="ml-auto">
                            <ProgressBar
                              color={state.color}
