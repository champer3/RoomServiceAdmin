...
export default function EditCategoryPage() {
  ...
  const { changePage, category, updateCategory } = useContext(PageContext);
  ...
  function handleSave() {
    const imageToUse =
      (files && files[0] && (files[0].preview || files[0])) || category.image;
          ...
          <div>
            ...
            <Path
              pages={[
                ...
                { name: "Edit Category", link: "edit-category" },
              ]}
            />
          </div>
      ...
      <div className="flex">
        <div className="w-[30%] p-3">
          <div className="mt-8 rounded-xl bg-white p-4">
            ...
            <p className="font-bold text-[14px] leading-[20px] tracking-[0.005em] text-[#777980]">
              Photo
            </p>
            <ImageDropzone
              description={"Drag and drop image here, or click add image"}
              files={files}
