...
export default function TopBar({ messages, notifications }) {
    ...
    return (
        <div className="flex items-center w-full h-[40px] mt-4 mb-3 p-4">
            ...
            <input className="bg-white border-none focus:border-[#F9F9FC] focus:ring-stone-200 rounded-lg outline-none w-full ml-1 text-[#858D9D] font-bold text-[14px] leading-[20px] tracking-[0.005em]" placeholder='Search'></input>
            <Link to={"/settings"}>
                <button>
