...
export default function CouponsInfoCard({ name, status, labelColor, leftData, leftDetail, rightData, rightDetail }) {
        ...
        <div className={`w-full rounded-lg ${isClicked ? 'border border-[#283618]' : ''} bg-white`}>
            <div className="w-full items-center p-2">
                <div className="flex items-center border-dotted p-2">
                    ...
                    <p className="font-black ml-auto mr-auto text-[16px] leading-[20px] tracking-[0.005em] text-[#333333]">{name}</p>
                ...
                <div className="h-0 border-dashed border-[1px] border-[#C2C6CE] mt-5 my-2 mx-3"></div>
            </div>
            <div className="flex pb-3 px-5 justify-center w-[100%] gap-[30%]">
                <div>
                    <p className="mb-1 font-bold text-[12px] leading-[18px] tracking-[0.005em] text-customGrey text-center">{leftDetail}</p>
                    <p className="font-bold text-[16px] leading-[20px] tracking-[0.005em] text-[#333333] text-center">{leftData}% off</p>
                </div>
                <div>
