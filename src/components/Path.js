                ...
                if (page !== currentPage)
                    return (
                        <div className="items-center flex">
                            <p className="mr-2 font-bold text-[14px] leading-[20px] tracking-[0.005em] text-[#BC6C25]">{page}</p>
                    ...
                    return <p className="font-bold text-[14px] leading-[20px] tracking-[0.005em] text-customGrey">{page}</p>
            })}
        </div>
    )
}